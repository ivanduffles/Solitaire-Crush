...
const BOMB_ICON_SVG = `
  <svg width="78" height="100" viewBox="0 0 78 100" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
    <g clip-path="url(#clip0_308_16903)">
      ...
      <circle cx="37.3086" cy="62.6914" r="25.043" fill="#FF6B6B"/>
      <path d="M66.4901 40.4203C63.6602 45.3218 55.176 47.9633 49.0459 44.424C42.9157 40.8848 40.3254 40.7008 43.4289 29.8862C44.2532 23.5453 47.7366 22.0421 58.4902 28.2507C64.6203 31.7899 69.3199 35.5188 66.4901 40.4203Z" fill="#FFB144"/>
