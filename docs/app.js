      ...
      if (!card) {
        ...
        if (card.isBomb) {
          cell.insertAdjacentHTML(
            "beforeend",
            `<span class="badge badge--bomb" aria-label="Bomb card">${BADGE_BOMB_ICON_SVG}</span>`
          );
        }
        if (card.isSwapper) {
          cell.insertAdjacentHTML(
            "beforeend",
            `<span class="badge badge--swapper" aria-label="Swapper card">${BADGE_SWAP_ICON_SVG}</span>`
          );
        }
      }
